...
src = src2 = MofologyImg = graphType = srcTemplate = temSrc = cdstP_X_Y = resized_img = resized_img_New = None
...
def main(argv):
    ...
    cv.imshow("Source", src) 
    cv.imshow("X axis Y axis ", resized_img_New)   
