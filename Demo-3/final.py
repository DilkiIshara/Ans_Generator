...
def main(argv):
    ...
    if linesP is not None: # Check there are lines
        ...
        # if graph is a Quadratic Graph
            ...
            src = cv.cvtColor(resized_img_New, cv.COLOR_BGR2GRAY)
            dst2 = cv.Canny(src, 20, 200, None, 3)             
            linesP2 = cv.HoughLinesP(dst2, 1, np.pi / 180, 25, None, 4, 15) 
            ...
            cv.imshow("resized_img", resized_img_New) 
