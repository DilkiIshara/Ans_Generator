...
def identify_X_Y():
    ...
    global X_axis_cordinate, found_X, Y_axis_cordinate, found_Y, arr_new, resized_img_New
    ...
    for k in range(0, len(linesP_new)):  
...
def main(argv):
    ...
    if linesP is not None: # Check there are lines
        ...
        # if graph is a Quadratic Graph
            ...
            typeofGraph = None
            if numberOf_Horizontal > 1:
                typeofGraph = "Parallel_X"
                print(" Parallel to X")
            elif numberOf_Vertical > 1:
                print(" Parallel to Y")
            ...
            if typeofGraph == "Parallel_X":  
                ...
                for i in range (0, noOfLines):
                    y = X_arr[i][0]
                    length = X_arr[i][1]
                    if ( length >= maxlength_X*0.5 and y != 0 and y != origin_Y): 
