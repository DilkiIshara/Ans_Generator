...
def getRealCoordianatesWithoutOCR():
    ...
    print(" Real Coordinates of X intersection Point  = " + str(real_intersection_Xaxis_X))
    print(" Real Coordinates of Y intersection Point  = " + str(real_intersection_Yaxis_Y))
...
def templateMatching():
    global srcTemplate, numberOf_Xaxis, numberOf_Yaxis, tem_y_arr, tem_x_arr, tem_Matching_Coordinates, xIndex , yIndex
